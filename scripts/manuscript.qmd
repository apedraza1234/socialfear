...
I'm leaving myself a note here to figure out how to do word count in a Quarto document. This will allow me to directly write in the qmd file and save the trouble of writing elsewhere like a word document and pasting things here.
...
Our control and independent variables are representative of two different dimensions we sought to capture. The first dimension is individual-level or identity characteristics:
