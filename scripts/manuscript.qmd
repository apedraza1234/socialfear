...
```{r}
#| label: pivot longer and pivot wider to get proportion of yes and no by race and display on a table
#| eval: false
...
%>% 
  summarize(proportion = fear /sum(fear == "yes", na.rm = TRUE)) %>% 
  kable(caption = "Proportion Social Fear by Race",
