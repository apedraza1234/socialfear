...
7.  "hispanic": Are you Spanish, Hispanic, or Latino/Latina? IF YES: Which group are you from? 8. "degree": Respondent's degree.

8.  "uscitzn": Are you a US citizen?

9.  "dwelown": (Do you/Does your family) own your (home/apartment), pay rent, or what?

# I modified the formatting of this list so that it appears numerically.
...
# instead of using view(), I would suggest using head() to take a look at the data within quarto.  
head(data)
view(data)
...
# I am unsure what this code chunk does. A comment may be useful for reproducibility. 
...
#the above recoding can also be done using factors. I also noticed that the results were difficult. 

na_data %>%
  mutate(racecombo1 = fct_recode(racerank1,
                                "White" = "White",
                                ...
                                "NHPI" ="Guamanian or Chamorro",
                                "NHPI" = "Samoan",
                                "NHPI" = "Other Pacific Islander",
                                "Other" = "Some other race")) %>%
  select("id", "age", "sex", "sexnow1", "sexornt", "degree", "attend", "raclive", "happy", "health", "helpful", "fair", "trust", "fear",  "partnrs5", "racecombo1", "uscitzn", "dwelown") %>%
  skim()

# It might be a good idea to do some descriptive statistics here just to have a quick look at your data. I'm using skimr here to inspect the data.
